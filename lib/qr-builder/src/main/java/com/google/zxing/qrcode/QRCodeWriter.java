...
public final class QRCodeWriter implements Writer {
  ...
  public BitMatrix encode(String contents,
    ...
    QRCode code = getQrCode(contents, format, hints);
    return renderResult(code, width, height, quietZone);
  }

  public QRCode getQrCode(String contents, BarcodeFormat format, Map<EncodeHintType,?> hints) throws WriterException {
    if (contents.isEmpty()) {
